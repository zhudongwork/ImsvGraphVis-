...
class BODYSTATE_API UBodyStateBPLibrary : public UBlueprintFunctionLibrary
{
	...
	static int32 DeviceAttached(const FBodyStateDeviceConfig& Configuration, TScriptInterface<IBodyStateInputInterface> InputCallbackDelegate);

	static int32 DeviceAttachedRaw(const FBodyStateDeviceConfig& Configuration, IBodyStateInputRawInterface* InputCallbackDelegate);
