...
void UBodyStateBone::ChangeBasis(const FRotator& PreBase, const FRotator& PostBase, bool AdjustVectors /*= true*/)
{
	...
	FRotator PostCombine = BodyStateUtility::CombineRotators(Orientation(), PostBase);
	BoneData.Transform.SetRotation(FQuat(BodyStateUtility::CombineRotators(PreBase, PostCombine)));
