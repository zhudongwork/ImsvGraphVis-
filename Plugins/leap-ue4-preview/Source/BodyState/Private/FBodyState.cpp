...
int32 FBodyState::DeviceAttached(const FBodyStateDeviceConfig& Configuration, IBodyStateInputRawInterface* InputCallbackDelegate)
{
	//Create Device
...
bool FBodyState::DeviceDetached(int32 DeviceID)
{
